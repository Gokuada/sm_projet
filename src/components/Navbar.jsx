...
const Popup = ({ isOpen, onClose }) => {
  ...
  return (
    <div
      className={`fixed inset-0 bg-black bg-opacity-50 backdrop-filter-blur z-50 flex items-center justify-center ${
        isOpen ? "" : "hidden"
      }`}
      ...
      <div className="bg-white p-8 rounded-lg max-w-md w-full mx-auto">
        <section className="bg-white dark:bg-gray-900">
          <div className="py-4 lg:py-8 px-4">
            <h2 className="mb-4 text-2xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Contactez-nous</h2>
            <p className="mb-4 lg:mb-8 font-light text-center text-gray-500 dark:text-gray-400 sm:text-base">Rencontrez-vous des problèmes techniques ? Souhaitez-vous nous faire part de vos commentaires sur une fonctionnalité ? Besoin d'informations sur notre plan Business ? N'hésitez pas à nous en informer.</p>
...
export default function Example() {
  ...
  return (
    <>
      <Disclosure
        as="nav"
        className="border-b-2 border-gray backdrop-filter-blur bg-gray-800 fixed w-full z-10"
      >
        {({ open }) => (
          <>
